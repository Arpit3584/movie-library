...
const Header = ({data}) => {
  ...
  return (
    ...
    className='w-full py-10 h-[45vh] flex flex-col justify-end items-start p-[10%] m-2'>
...
<p className='mt-5 w-[70%] text-white'>
  ...
  <Link to={`${data.media_type}/details/${data.id}/trailer`} className='bg-[#6556CD] p-3 rounded-md text-white font-semibold mt-2'>Watch Trailer</Link>
   </div>
