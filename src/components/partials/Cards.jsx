...
const Cards = ({data,title}) => {
...

  {
    ...
    className='relative w-[25vh] mr-[5%] mb-[5%]' key={i}>
        ...
        src={c.backdrop_path||c.poster_path||c.profile_path?`https://image.tmdb.org/t/p/original/${c.backdrop_path||c.poster_path||c.profile_path}`:noImage} alt=''/>
       <h1 className='text-2xl text-zinc-400 mt-3 font-semibold'>
        {c.name||c.title||c.original_name||c.original_title}
        </h1>
        {c.vote_average&&(
        <div className=' absoulte right-[-10%] bottom-[25%] text-white rounded-full bg-yellow-600
