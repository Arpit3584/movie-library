  ...
  <div className='w-[100%] flex overflow-y-hidden mb-5 p-5 '>

    {
      info.detail.seasons.map((s,i)=>(
       <div className='m-2'>
        <img className='shadow-[8px_17px_38px_2px_rgba(0,0,0,.5)] object-scale-down h-[30vh] w-[20vw]'
  src={`https://image.tmdb.org/t/p/original/${s.backdrop_path||s.poster_path||s.profile_path}`} alt=''/>
